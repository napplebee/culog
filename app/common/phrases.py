...
class Phrase(object):
    ...
    def __init__(self, about, recipes, recent_recipes,
                 ...
                 load_more, read_more, amount_types):
        self.about = about
...
PHRASES = {
    "ru": Phrase(u"Обо мне", u"Рецепты", u"Недавние рецепты", u"Категории", u"Вам может понравится", u"Все права защищены", u"Показать еще", u"читать дальше",
         {"gr": "гр.", "ml": "мл.", "item": "", "tsp": "ч.л.", "tbsp": "ст.л.", "cup": "стакана", "kg": "кг.", "liter": "л."}
     ),
    "en": Phrase(u"About", u"Recipes", u"Recent recipes", u"Categories", u"You may like", u"All rights reserved", u"Load more", u"read now",
